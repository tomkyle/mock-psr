...
trait MockPsr7MessagesTrait
{
    ...
    protected function mockServerRequest(array $attributes = array(), array $headers = array()) : ServerRequestInterface {
    ...
    protected function mockUri( $uri ) : UriInterface
    {
    ...
    protected function mockRequest(string $method, $uri) : RequestInterface {
    ...
    protected function mockStream( string $body = '',  array $options = array()) : StreamInterface {
    ...
    protected function mockResponse( int $status = 200, $body = null) : ResponseInterface {
